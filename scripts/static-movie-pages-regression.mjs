...
const checks = [
  ...
  [generator.includes('hasPlayableMovieEvidence') && worker.includes('hasPlayableMovieEvidence(movie)') && generator.includes("'@type': 'WatchAction'") && worker.includes("'@type': 'WatchAction'"), 'Static and edge renderers must use playback evidence before advertising WatchAction'],
