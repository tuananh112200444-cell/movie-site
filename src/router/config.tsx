...
const routes: RouteObject[] = [
  ...
  { path: '/xem-phim-moi', element: <LazySeoLanding landingKey="xem-phim-moi" /> },
  { path: '/xem-phim-le', element: <LazySeoLanding landingKey="xem-phim-le" /> },
  { path: '/xem-phim-bo', element: <LazySeoLanding landingKey="xem-phim-bo" /> },
  { path: '/xem-phim-chieu-rap', element: <LazySeoLanding landingKey="xem-phim-chieu-rap" /> },
  { path: '/xem-phim-viet-nam', element: <LazySeoLanding landingKey="xem-phim-viet-nam" /> },
  { path: '/xem-phim-han-quoc', element: <LazySeoLanding landingKey="xem-phim-han-quoc" /> },
  { path: '/xem-phim-trung-quoc', element: <LazySeoLanding landingKey="xem-phim-trung-quoc" /> },
  { path: '/xem-phim-au-my', element: <LazySeoLanding landingKey="xem-phim-au-my" /> },
  { path: '/xem-anime-vietsub', element: <LazySeoLanding landingKey="xem-anime-vietsub" /> },
