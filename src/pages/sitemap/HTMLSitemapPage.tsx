...
const SEO_PAGES = [
  ...
  { name: 'Xem phim mới', path: '/phim-moi-cap-nhat' },
  { name: 'Xem phim lẻ', path: '/phim-le' },
  { name: 'Xem phim bộ', path: '/phim-bo' },
  { name: 'Xem phim chiếu rạp', path: '/phim-chieu-rap' },
  { name: 'Xem phim Việt Nam', path: '/phim-viet-nam' },
  { name: 'Xem phim Hàn Quốc', path: '/phim-han-quoc' },
  { name: 'Xem phim Trung Quốc', path: '/phim-trung-quoc' },
  { name: 'Xem phim Âu Mỹ', path: '/phim-au-my' },
  { name: 'Xem anime Vietsub', path: '/anime' },
