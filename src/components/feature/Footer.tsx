...
const SEO_LANDING_LINKS = [
  ...
  { label: 'Xem Phim Mới', to: '/phim-moi-cap-nhat', icon: 'ri-flashlight-line' },
  { label: 'Xem Phim Chiếu Rạp', to: '/phim-chieu-rap', icon: 'ri-movie-2-line' },
  { label: 'Xem Phim Việt Nam', to: '/phim-viet-nam', icon: 'ri-flag-line' },
  { label: 'Xem Anime Vietsub', to: '/anime', icon: 'ri-gamepad-line' },
